...
function setup() {
  ...
  world = engine.world;
   ...
   bone1= new Bone(300,130)
   bone2= new Bone(380,130)
   bone3= new Bone(460,130)
   bone4= new Bone(540,130)
   bone5= new Bone(620,130)
   bone6= new Bone(700,130)
   bone7= new Bone(780,130)
   bone8= new Bone(860,130)
   bone9= new Bone(940,130)
   bone10= new Bone(1020,130)
   bone11= new Bone(1100,130)
   bone12= new Bone(1180,130)
   bone13= new Bone(300,460)
   bone14= new Bone(380,460)
   bone15= new Bone(460,460)
   bone16= new Bone(540,460)
   bone17= new Bone(620,460)
   bone18= new Bone(700,460)
   bone19= new Bone(780,460)
   bone20= new Bone(860,460)
   bone21= new Bone(940,460)
   bone22= new Bone(1020,460)
   bone23= new Bone(1100,460)
   bone24= new Bone(1180,460)
   bone25= new Bone(300,190)
   bone26= new Bone(300,280)
   bone27= new Bone(300,370)
   bone28= new Bone(1210,190)
   bone29= new Bone(1210,280)
   bone30= new Bone(1210,370)
   bone31= new Bone(400,190)
   bone32= new Bone(400,280)
   bone33= new Bone(400,370)
   bone34= new Bone(500,190)
   bone35= new Bone(500,280)
   bone36= new Bone(500,370)
   bone37= new Bone(580,190)
   bone38= new Bone(580,280)
   bone39= new Bone(580,370)
   bone40= new Bone(820,190)
   bone41= new Bone(820,280)
   bone42= new Bone(820,370)
   bone43= new Bone(930,190)
   bone44= new Bone(930,280)
   bone45= new Bone(930,370)
   bone46= new Bone(1060,190)
   bone47= new Bone(1060,280)
   bone48= new Bone(1060,370)
...
//display player object
 ...
 bone48.score();
  ...
  if(dog.isTouching(bone2))
    ...
    if(dog.isTouching(bone23))
    {
      bone23.destroy();
      score = score+1;
    } 
   
    if(dog.isTouching(bone24))
    {
      bone24.destroy();
      score = score+1;
    }
    if(dog.isTouching(bone25))
    {
      bone25.destroy();
      score = score+1;
    }
    if(dog.isTouching(bone26))
    {
      bone26.destroy();
      score = score+1;
    }
    if(dog.isTouching(bone27))
    {
      bone27.destroy();
      score = score+1;
    }
    if(dog.isTouching(bone28))
    {
      bone28.destroy();
      score = score+1;
    }
